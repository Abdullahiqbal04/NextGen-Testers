...
async def run_deep_search(research_task, max_search_iteration_input, max_query_per_iter_input, llm_provider,
                          llm_model_name, llm_num_ctx, llm_temperature, llm_api_key, use_vision,
...
def create_ui(theme_name="Ocean"):
   ...
   /* Target the image frame inside component-3 */
    #component-3 {
        border: none !important;
        box-shadow: none !important;
    }

    /* Also apply to the internal image-frame div */
    #component-3 .image-frame {
        border: none !important;
        box-shadow: none !important;
        background: transparent !important;
    }

    /* Optional: Tweak the image itself for clean layout */
    #component-3 img {
        width: 50%;
        height: auto;
        display: block;
    ...
    .gold-button {
        background: rgb(246, 205, 71) !important;
        color: black !important;
    }

    .grey-button {
        background: #a6a9a9 !important;
        color: black !important;
    }
    ...
    .gradio-container.gradio-container-5-23-1 .contain .header-text {
        margin-bottom: 10px !important;
    }

    .center-content .tab-container {
        justify-content: center;
    }
    """

    with gr.Blocks(
            title="Vroozi Automation - ", theme=gr.themes.Default(primary_hue=gr.themes.utils.colors.yellow), css=css
    ) as demo:
        with gr.Row(elem_classes="centered-row"):
            with gr.Column(elem_classes="centered-column"):
                gr.Image(value="./assets/vroozi-logo.png", label="Logo", show_label=False)
                gr.Markdown(
                    """
        ...
        with gr.Tabs(elem_classes=["center-content"]) as tabs:
...
#                         ADD API KEY
            ...
            with gr.TabItem("Run Agent", id=4):
                ...
                with gr.Row():
                    run_button = gr.Button("Run Agent", variant="primary", scale=2, elem_classes=["gold-button"])
                    stop_button = gr.Button("Stop", variant="stop", scale=1, elem_classes=["grey-button"])
            ...
            run_button.click(
                fn=run_with_stream,
                inputs=[
                    agent_type, llm_provider, llm_model_name, ollama_num_ctx, llm_temperature,
                    llm_api_key,
            ...
            with gr.TabItem("Recordings", id=7, visible=True):
                ...
                refresh_button = gr.Button("Refresh Recordings", variant="secondary", elem_classes=["grey-button"])
